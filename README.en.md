...
Set up an HTTPS server using Python and openssl commands.

# DEMO

* [DEMO](https://ytyaru.github.io/JS.Https.Server.Python.OpenSsl.20250330110350/)
...
```sh
cd JS.Https.Server.Python.OpenSsl.20250330110350/src
./run.sh
```
